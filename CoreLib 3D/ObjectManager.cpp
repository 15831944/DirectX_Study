...
bool ObjectManager::Render(ID3D11DeviceContext* pDContext) noexcept
{
	...
	{
		if (type == EObjType::Object || type == EObjType::Map)
		{
...
GameObject* ObjectManager::TakeObject(const wstring_view& objName) noexcept
{
...
bool ObjectManager::RemoveObject(GameObject* pObject) noexcept
{
	...
	auto deleteEvent = [](void* pVoid, void*) {
		auto pObj = (GameObject*)pVoid;
		pObj->CutParent();
