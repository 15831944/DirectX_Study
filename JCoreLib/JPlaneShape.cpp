...
//=======================================PlaneShape=======================================
//========================================================================================
bool JPlaneShape::Create(const char* szPSFunName, const char* szVSFunName, const TCHAR* szShaderName)
{
	PNCT_VERTEX vertices[] =
	{
		{ D3DXVECTOR3(-1.0f, 1.0f, 0.0f),  D3DXVECTOR3(0.0f, 0.0f, -1.0f), D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f), D3DXVECTOR2(-1.0f, -1.0f) },
		{ D3DXVECTOR3(1.0f, 1.0f, 0.0f),   D3DXVECTOR3(0.0f, 0.0f, -1.0f), D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f), D3DXVECTOR2(1.0f, -1.0f) },
		{ D3DXVECTOR3(1.0f, -1.0f, 0.0f),  D3DXVECTOR3(0.0f, 0.0f, -1.0f), D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f), D3DXVECTOR2(1.0f, 1.0f) },
		{ D3DXVECTOR3(-1.0f, -1.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -1.0f), D3DXVECTOR4(1.0f, 0.0f, 0.0f, 1.0f), D3DXVECTOR2(-1.0f, 1.0f) },
	};
...
bool JPlaneShape::Frame()
{
	return true;
}
bool JPlaneShape::PreRender(ID3D11DeviceContext* context, UINT iVertexSize)
{
	...
	context->PSSetConstantBuffers(0, 1, &m_dxObj.m_pConstantBuffer);
	
	if (m_dxObj.m_pTexture != nullptr)
		context->PSSetShaderResources(0, 1, &m_dxObj.m_pTexture->m_pSRV);
	return true;
}
bool JPlaneShape::PostRender(ID3D11DeviceContext* context, UINT iCount)
{
...
bool JPlaneShape::Render(ID3D11DeviceContext* context, UINT iVertexSize, UINT iCount)
{
